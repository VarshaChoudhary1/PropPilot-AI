...
export default function Dashboard() {
  ...
  const lowIntent = leads.filter((lead) => lead.score < 50).length;

  const averageScore = Math.round(
    leads.reduce((sum, lead) => sum + lead.score, 0) / leads.length
  );

  const topScore = Math.max(...leads.map((lead) => lead.score));
    ...
    <main className="min-h-screen bg-[#f4f2ec] px-5 py-8 text-[#111111] sm:px-6 lg:px-10 lg:py-10">
      <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col justify-between gap-8 p-6 sm:p-8 lg:flex-row lg:items-center lg:p-10">
            ...
            <div>
              ...
              <h2 className="mt-5 text-2xl font-semibold tracking-tight sm:text-3xl">
                {highIntent} lead{highIntent !== 1 ? "s" : ""} require
                immediate attention.
              </h2>

              <p className="mt-3 max-w-2xl text-sm leading-6 text-[#aaa69e]">
                Strong buying signals detected. Contact high-intent prospects
                first to maximize your chances of conversion.
              </p>
        ...
        <section className="mt-8 overflow-hidden rounded-[2rem] bg-[#111111] text-white">
          ...
          {/* Section Header */}
          <div className="flex flex-col justify-between gap-4 border-b border-[#30302e] px-6 py-6 sm:flex-row sm:items-center sm:px-8">
            <div>
              <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 rounded-full border border-[#3b3b38] px-4 py-2 text-xs text-[#aaa69e]">
        ...
        <section className="mt-8 grid gap-4 lg:grid-cols-[1.4fr_1fr]">
          ...
          <div className="rounded-[2rem] border border-[#dedbd3] bg-white p-6 sm:p-8">
            ...
            <p className="mt-3 max-w-xl text-sm leading-6 text-[#6b675f]">
              Rahul Sharma has the strongest buying signals with a lead score
              of 92. The recommended action is to contact him immediately.
            </p>

            <div className="mt-6 flex flex-wrap gap-3">
              <div className="rounded-2xl bg-[#f4f2ec] px-4 py-3">
                <p className="text-[10px] uppercase tracking-wider text-[#77736b]">
                  Lead
                </p>
              ...
              <div className="rounded-2xl bg-[#111111] px-4 py-3 text-white">
                <p className="text-[10px] uppercase tracking-wider text-[#77736b]">
                  Score
                </p>
...
function LeadRow({
  ...
  return (
    <div className="group grid gap-6 px-6 py-7 transition-colors hover:bg-[#171716] sm:px-8 lg:grid-cols-[1.1fr_1.5fr_1fr_1fr_1.3fr] lg:items-center">
